// Pool registry for backend processes.
//
...
>()("@piku/desktop/backend/DesktopBackendPool") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    // calls, so on app shutdown a registered backend child process gets
