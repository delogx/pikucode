...
const requestLogPath = process.env.PIKU_ACP_REQUEST_LOG_PATH;
const exitLogPath = process.env.PIKU_ACP_EXIT_LOG_PATH;
const emitToolCalls = process.env.PIKU_ACP_EMIT_TOOL_CALLS === "1";
const emitInterleavedAssistantToolCalls =
  process.env.PIKU_ACP_EMIT_INTERLEAVED_ASSISTANT_TOOL_CALLS === "1";
const emitGenericToolPlaceholders = process.env.PIKU_ACP_EMIT_GENERIC_TOOL_PLACEHOLDERS === "1";
const emitPostSettleMonitorFlow = process.env.PIKU_ACP_EMIT_POST_SETTLE_MONITOR_FLOW === "1";
const emitInTurnTaskOutputThenLateDuplicate =
  process.env.PIKU_ACP_EMIT_IN_TURN_TASKOUTPUT_THEN_LATE_DUPLICATE === "1";
const injectedReportTriggerPath = process.env.PIKU_ACP_INJECTED_REPORT_TRIGGER_PATH;
const emitAskQuestion = process.env.PIKU_ACP_EMIT_ASK_QUESTION === "1";
const emitElicitation = process.env.PIKU_ACP_EMIT_ELICITATION === "1";
const emitUrlElicitation = process.env.PIKU_ACP_EMIT_URL_ELICITATION === "1";
const emitXAiAskUserQuestion = process.env.PIKU_ACP_EMIT_XAI_ASK_USER_QUESTION === "1";
const emitXAiPromptCompleteThenHang =
  process.env.PIKU_ACP_EMIT_XAI_PROMPT_COMPLETE_THEN_HANG === "1";
const emitForeignSessionUpdates = process.env.PIKU_ACP_EMIT_FOREIGN_SESSION_UPDATES === "1";
const hangPromptForever = process.env.PIKU_ACP_HANG_PROMPT_FOREVER === "1";
const hangAfterPermission = process.env.PIKU_ACP_HANG_AFTER_PERMISSION === "1";
const hangFirstPromptForever = process.env.PIKU_ACP_HANG_FIRST_PROMPT_FOREVER === "1";
const emitLateUpdateAfterCancel = process.env.PIKU_ACP_EMIT_LATE_UPDATE_AFTER_CANCEL === "1";
const emitTaskBackgroundedAfterCancel =
  process.env.PIKU_ACP_EMIT_TASK_BACKGROUNDED_AFTER_CANCEL === "1";
const residualCallbackResponseLogPath = process.env.PIKU_ACP_RESIDUAL_CALLBACK_RESPONSE_LOG_PATH;
const residualCallbackTriggerPath = process.env.PIKU_ACP_RESIDUAL_CALLBACK_TRIGGER_PATH;
const exitAfterResidualCallbacks = process.env.PIKU_ACP_EXIT_AFTER_RESIDUAL_CALLBACKS === "1";
const emitRunningCommandThenHang = process.env.PIKU_ACP_EMIT_RUNNING_COMMAND_THEN_HANG === "1";
const emitRunningCommandThenHangOnFirstPrompt =
  process.env.PIKU_ACP_EMIT_RUNNING_COMMAND_THEN_HANG_FIRST_PROMPT === "1";
const emitEmptySuccessfulBash = process.env.PIKU_ACP_EMIT_EMPTY_SUCCESSFUL_BASH === "1";
const emitEmptySuccessfulBashThenHang =
  process.env.PIKU_ACP_EMIT_EMPTY_SUCCESSFUL_BASH_THEN_HANG === "1";
const exitOnCancel = process.env.PIKU_ACP_EXIT_ON_CANCEL === "1";
const runningCommandIgnoresTerm = process.env.PIKU_ACP_RUNNING_COMMAND_IGNORE_TERM === "1";
const runningCommandPidPath = process.env.PIKU_ACP_RUNNING_COMMAND_PID_PATH;
const runningCommandSeparateSession = process.env.PIKU_ACP_RUNNING_COMMAND_SEPARATE_SESSION === "1";
const exitAfterRunningCommandLaunch =
  process.env.PIKU_ACP_EXIT_AFTER_RUNNING_COMMAND_LAUNCH === "1";
const omitXAiPromptCompleteStopReason =
  process.env.PIKU_ACP_OMIT_XAI_PROMPT_COMPLETE_STOP_REASON === "1";
const failLoadSession = process.env.PIKU_ACP_FAIL_LOAD_SESSION === "1";
const emitLoadReplay = process.env.PIKU_ACP_EMIT_LOAD_REPLAY === "1";
const hangLoadSessionAfterReplay = process.env.PIKU_ACP_HANG_LOAD_SESSION_AFTER_REPLAY === "1";
const delayLoadSessionAfterReplay = process.env.PIKU_ACP_DELAY_LOAD_SESSION_AFTER_REPLAY === "1";
const loadSessionDelayMs = Number(process.env.PIKU_ACP_LOAD_SESSION_DELAY_MS ?? "5000");
const emitStaleXAiPromptCompleteBeforeSecondHang =
  process.env.PIKU_ACP_EMIT_STALE_XAI_PROMPT_COMPLETE_BEFORE_SECOND_HANG === "1";
const emitOverlappingXAiPromptCompleteOutOfOrder =
  process.env.PIKU_ACP_EMIT_OVERLAPPING_XAI_PROMPT_COMPLETE_OUT_OF_ORDER === "1";
const failPrompt = process.env.PIKU_ACP_FAIL_PROMPT === "1";
const failSetConfigOption = process.env.PIKU_ACP_FAIL_SET_CONFIG_OPTION === "1";
const exitOnSetConfigOption = process.env.PIKU_ACP_EXIT_ON_SET_CONFIG_OPTION === "1";
const promptResponseText = process.env.PIKU_ACP_PROMPT_RESPONSE_TEXT;
const promptDelayMs = Number(process.env.PIKU_ACP_PROMPT_DELAY_MS ?? "0");
const supportsSessionLifecycle = process.env.PIKU_ACP_SESSION_LIFECYCLE === "1";
const advertisedAuthMethodId = process.env.PIKU_ACP_AUTH_METHOD_ID?.trim();
const requiresAuthentication = process.env.PIKU_ACP_REQUIRE_AUTH === "1";
const permissionOptionIds = {
  allowOnce: process.env.PIKU_ACP_ALLOW_ONCE_OPTION_ID ?? "allow-once",
  allowAlways: process.env.PIKU_ACP_ALLOW_ALWAYS_OPTION_ID ?? "allow-always",
  rejectOnce: process.env.PIKU_ACP_REJECT_ONCE_OPTION_ID ?? "reject-once",
};
...
const mockAcpModels: ReadonlyArray<AcpSchema.ModelInfo> = [
  { modelId: "mock-model", name: "Mock Model" },
  { modelId: "mock-model-alt", name: "Mock Model Alt" },
];

function modelState(): AcpSchema.SessionModelState {
  const modelId = mockAcpModels.some((model) => model.modelId === currentModelId)
    ? currentModelId
    : "mock-model";
  return {
    currentModelId: modelId,
    availableModels: mockAcpModels,
  };
}
...
const program = Effect.gen(function* () {
  ...
  yield* agent.handleSetSessionModel((request) =>
    Effect.gen(function* () {
      if (!mockAcpModels.some((model) => model.modelId === request.modelId)) {
        return yield* AcpError.AcpRequestError.invalidParams(
