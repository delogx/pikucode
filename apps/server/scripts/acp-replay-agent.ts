...
const encodedTranscript = process.env.PIKU_ACP_REPLAY_TRANSCRIPT;
const statusPath = process.env.PIKU_ACP_REPLAY_STATUS_PATH;
const replayWorkspace = process.env.PIKU_ACP_REPLAY_WORKSPACE ?? process.cwd();
