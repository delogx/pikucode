...
import { ProviderInstanceId, type ProviderReplayEntry } from "@piku/contracts";
...
const MODEL_SELECTION = {
  ...
  model: process.env.PIKU_CLAUDE_REPLAY_MODEL ?? "claude-sonnet-4-6",
} as const;
const SOURCE_PROMPT =
...
const sessionId =
  process.env.PIKU_CLAUDE_REPLAY_SESSION_ID ?? (await Effect.runPromise(randomUuidV4));
