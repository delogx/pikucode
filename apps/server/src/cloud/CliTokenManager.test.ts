import { readConnectAuthorizeRequest } from "@piku/shared/connectAuth";
...
const TEST_ENV = {
  PIKU_CLERK_PUBLISHABLE_KEY: "pk_test_Y2xlcmsuZXhhbXBsZS50ZXN0JA==",
  PIKU_CLERK_CLI_OAUTH_CLIENT_ID: "oauth_client_test",
  PIKU_HOSTED_APP_URL: "https://hosted.example.test",
};
