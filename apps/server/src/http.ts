...
import { isDevProxiedPath } from "@piku/shared/devProxy";
import { decodeOtlpTraceRecords } from "@piku/shared/observability";
...
const DESKTOP_RENDERER_ORIGINS = ["piku://app", "piku-dev://app"];
...
export const browserApiCorsLayer = Layer.unwrap(
  Effect.gen(function* () {
    ...
    //
    // PIKU_DEV_ALLOWED_ORIGINS covers dev servers reached from a second
    // origin — a hostname, a LAN IP, a phone. Browser dev normally proxies
