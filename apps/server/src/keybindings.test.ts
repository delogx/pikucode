import { KeybindingCommand, KeybindingRule, KeybindingsConfig } from "@piku/contracts";
...
import { KeybindingsConfigError } from "@piku/contracts";
    ...
    Layer.provideMerge(
      Layer.fresh(
        ServerConfig.layerTest(process.cwd(), {
          prefix: "pikucode-keybindings-test-",
        }),
      ),
    ),
  );
