        ...
        Effect.gen(function* () {
          ...
          yield* Effect.gen(function* () {
            ...
            const threadListTool = server.tools.find(
              ({ tool }) => tool.name === "piku_thread_list",
            );
            ...
            expect(capabilities.structuredContent).toMatchObject({
              ...
              providers: expect.arrayContaining([
                ...
                expect.objectContaining({
                  providerInstanceId: "acpRegistry",
            ...
            const childFollowupCall = yield* invoke("piku_thread_send", {
              threadId: delegated.childThreadId,
            ...
            const childFollowupWaitCall = yield* invoke("piku_thread_wait", {
              threadId: delegated.childThreadId,
            ...
            const activeChildFollowupCall = yield* invoke("piku_thread_send", {
              threadId: delegated.childThreadId,
            ...
            const activeChildCleanupCall = yield* invoke("piku_thread_interrupt", {
              threadId: delegated.childThreadId,
            ...
            const promptedReadCall = yield* invoke("piku_thread_read", {
            ...
            const promptedReadNextCall = yield* invoke("piku_thread_read", {
              threadId: promptedThread.threadId,
            ...
            const forkedReadCall = yield* invoke("piku_thread_read", {
            ...
            const sendCall = yield* invoke("piku_thread_send", {
            ...
            const waitCall = yield* invoke("piku_thread_wait", {
              threadId: emptyThread.threadId,
              runId: sent.runId,
              timeoutMs: 10_000,
            });
            ...
            const repeatedSendCall = yield* invoke("piku_thread_send", {
              threadId: emptyThread.threadId,
              message: ordinaryLoopPrompt,
              clientRequestId: "ordinary-loop-send-1",
            });
            ...
            const activeThreadCall = yield* invoke("piku_thread_start", {
            ...
            const activeTimeoutCall = yield* invoke("piku_thread_wait", {
            ...
            const steerCall = yield* invoke("piku_thread_send", {
              threadId: activeThread.threadId,
            ...
            const interruptCall = yield* invoke("piku_thread_interrupt", {
              threadId: activeThread.threadId,
            ...
            const interruptedWaitCall = yield* invoke("piku_thread_wait", {
              threadId: activeThread.threadId,
              runId: activeRun.id,
              timeoutMs: 10_000,
            });
            ...
            const repeatedInterruptCall = yield* invoke("piku_thread_interrupt", {
              threadId: activeThread.threadId,
              runId: activeRun.id,
            });
            ...
            const foreignReadCall = yield* invoke("piku_thread_read", {
              threadId: foreignThreadId,
            });
            ...
            const listCall = yield* invoke("piku_thread_list", {
