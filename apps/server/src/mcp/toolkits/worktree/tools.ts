...
export const WorktreeHandoffTool = Tool.make("piku_worktree_handoff", {
  description:
...
export const WorktreeStatusTool = Tool.make("piku_worktree_status", {
  description:
    "Report this agent thread's worktree binding: whether it is attached to a git worktree, the worktree path and branch, the project's main workspace root, and the server default for piku_worktree_handoff's startFromOrigin. Call this before piku_worktree_handoff to check whether a handoff is possible or has already happened.",
