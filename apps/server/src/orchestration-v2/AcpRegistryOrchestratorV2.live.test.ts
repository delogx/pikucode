...
const liveAgentId = process.env.PIKU_ACP_REGISTRY_LIVE_AGENT_ID?.trim() || "devin";
const liveCommandPath = process.env.PIKU_ACP_REGISTRY_LIVE_COMMAND?.trim();
...
const serverConfigLayer = ServerConfig.layerTest(process.cwd(), {
  prefix: "piku-acp-registry-v2-live-",
});
...
describe.runIf(process.env.PIKU_ACP_REGISTRY_LIVE_ORCHESTRATOR === "1")(
