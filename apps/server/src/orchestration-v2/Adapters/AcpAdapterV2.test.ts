  ...
  it.effect("denies mutations through workspace symlinks that escape the writable roots", () =>
    Effect.gen(function* () {
      ...
      const workspace = yield* fileSystem.makeTempDirectoryScoped({
        prefix: "piku-acp-permission-workspace-",
      });
      const outside = yield* fileSystem.makeTempDirectoryScoped({
        prefix: "piku-acp-permission-outside-",
      });
  ...
  it.effect("allows existing and new files beneath canonical writable roots", () =>
    Effect.gen(function* () {
      ...
      const workspaceLinkParent = yield* fileSystem.makeTempDirectoryScoped({
        prefix: "piku-acp-permission-link-parent-",
      });
...
describe("AcpAdapterV2", () => {
      ...
      const failed = yield* Effect.scoped(
        Effect.gen(function* () {
          const commandPidPath = yield* fileSystem.makeTempFileScoped({
            prefix: "piku-acp-forced-failure-command-",
          });
  ...
  it.live("reaps detached native work when the provider exits before explicit teardown", () =>
    Effect.gen(function* () {
      ...
      const commandPidPath = yield* fileSystem.makeTempFileScoped({
        prefix: "piku-acp-provider-exit-command-",
      });
      yield* Effect.addFinalizer(() =>
        Effect.sync(() => cleanupPublishedDetachedFixture(commandPidPath)),
      );
      ...
      const adapter = makeAcpAdapterV2({
        ...
        flavor: {
          ...
          makeRuntime: makeMockRuntime({
            ...
            environment: {
              PIKU_ACP_EMIT_RUNNING_COMMAND_THEN_HANG: "1",
              PIKU_ACP_EXIT_AFTER_RUNNING_COMMAND_LAUNCH: "1",
              PIKU_ACP_RUNNING_COMMAND_PID_PATH: commandPidPath,
              PIKU_ACP_RUNNING_COMMAND_SEPARATE_SESSION: "1",
            },
          }),
        },
        fileSystem,
      ...
      const cgroupController: AcpSessionRuntime.AcpLinuxCgroupController = {
        create: () => {
          ...
          return {
            contains: () => false,
            exists: () => cgroupExists,
            path: "/definitely-missing/piku-acp-cgroup",
            relativePath: "/definitely-missing/piku-acp-cgroup",
            kill: () => {
              killCalls += 1;
            },
            populated: () => false,
  ...
  it.effect("reconfigures a loaded ACP session from its own active setup metadata", () =>
    Effect.gen(function* () {
      ...
      const originalSelection = { instanceId, model: "mock-model" } satisfies ModelSelection;
      const runtime = yield* adapter.openSession({
      ...
      const adapter = makeAcpAdapterV2({
        ...
        flavor: {
          ...
          makeRuntime: makeMockRuntime({
            ...
            mockAgentPath,
            environment: (runtimeOrdinal) =>
              runtimeOrdinal === 1 ? { PIKU_ACP_EMIT_EMPTY_SUCCESSFUL_BASH_THEN_HANG: "1" } : {},
            ownDetachedProcessGroup: true,
            protocolEvents,
          }),
      ...
      const adapter = makeAcpAdapterV2({
        ...
        flavor: {
          ...
          makeRuntime: makeMockRuntime({
            childProcessSpawner,
            mockAgentPath,
            environment: { PIKU_ACP_EMIT_TOOL_CALLS: "1" },
      ...
      const adapter = makeAcpAdapterV2({
        ...
        flavor: {
          ...
          makeRuntime: makeMockRuntime({
            childProcessSpawner,
            mockAgentPath,
            environment: { PIKU_ACP_EMIT_ELICITATION: "1" },
      ...
      const adapter = makeAcpAdapterV2({
        ...
        flavor: {
          ...
          makeRuntime: makeMockRuntime({
            ...
            mockAgentPath,
            environment: {
              PIKU_ACP_EMIT_TOOL_CALLS: "1",
              PIKU_ACP_HANG_AFTER_PERMISSION: "1",
            },
            ownDetachedProcessGroup: true,
      ...
      const adapter = makeAcpAdapterV2({
        ...
        flavor: {
          ...
          makeRuntime: makeMockRuntime({
            childProcessSpawner,
            mockAgentPath,
            environment: { PIKU_ACP_EMIT_URL_ELICITATION: "1" },
            ownDetachedProcessGroup: true,
            processGroupPlatform: "win32",
            windowsProcessTreeTerminator: (pid) =>
              Effect.sync(() => {
      ...
      const adapter = makeAcpAdapterV2({
        ...
        flavor: {
          ...
          makeRuntime: makeMockRuntime({
            childProcessSpawner,
            mockAgentPath,
            environment: { PIKU_ACP_PROMPT_DELAY_MS: "5000" },
            protocolEvents,
          }),
        },
        fileSystem,
      ...
      const adapter = makeAcpAdapterV2({
        ...
        flavor: {
          ...
          makeRuntime: makeMockRuntime({
            ...
            mockAgentPath,
            ownDetachedProcessGroup: true,
            environment: { PIKU_ACP_HANG_PROMPT_FOREVER: "1" },
            protocolEvents,
          }),
        },
        fileSystem,
      ...
      const adapter = makeAcpAdapterV2({
        ...
        flavor: {
          ...
          makeRuntime: makeMockRuntime({
            childProcessSpawner,
            mockAgentPath,
            environment: { PIKU_ACP_EMIT_GENERIC_TOOL_PLACEHOLDERS: "1" },
            protocolEvents,
          }),
        },
        fileSystem,
          ...
          flavor: {
            ...
            makeRuntime: makeMockRuntime({
              ...
              environment: (runtimeOrdinal) => {
                ...
                return { PIKU_ACP_EMIT_GENERIC_TOOL_PLACEHOLDERS: "1" };
              },
              protocolEvents,
              wrapCancel: (cancel) =>
                Effect.sync(() => {
          ...
          flavor: {
            ...
            makeRuntime: makeMockRuntime({
              ...
              environment: (runtimeOrdinal) => {
                runtimeOrdinalSeen = Math.max(runtimeOrdinalSeen, runtimeOrdinal);
                return {
                  PIKU_ACP_EMIT_RUNNING_COMMAND_THEN_HANG_FIRST_PROMPT: "1",
                  PIKU_ACP_EMIT_TASK_BACKGROUNDED_AFTER_CANCEL: "1",
                };
              },
              protocolEvents,
              wrapCancel: (cancel) =>
      ...
      const adapter = makeAcpAdapterV2({
        ...
        flavor: {
          ...
          makeRuntime: makeMockRuntime({
            ...
            environment: (runtimeOrdinal) => {
              runtimeOrdinalSeen = Math.max(runtimeOrdinalSeen, runtimeOrdinal);
              return runtimeOrdinal === 1 ? { PIKU_ACP_HANG_PROMPT_FOREVER: "1" } : {};
            },
            ownDetachedProcessGroup: true,
            protocolEvents,
          }),
        ...
        const adapter = makeAcpAdapterV2({
          ...
          flavor: {
            ...
            makeRuntime: makeMockRuntime({
              ...
              mockAgentPath,
              environment: {
                PIKU_ACP_EMIT_IN_TURN_TASKOUTPUT_THEN_LATE_DUPLICATE: "1",
              },
              protocolEvents,
            }),
          },
        ...
        const adapter = makeAcpAdapterV2({
          ...
          flavor: {
            ...
            makeRuntime: makeMockRuntime({
              ...
              mockAgentPath,
              environment: {
                PIKU_ACP_EMIT_POST_SETTLE_MONITOR_FLOW: "1",
                PIKU_ACP_INJECTED_REPORT_TRIGGER_PATH: triggerPath,
              },
              protocolEvents,
            }),
          },
      ...
      const context = yield* Layer.build(
        AcpSessionRuntime.layer({
          spawn: {
            ...
            args: [mockAgentPath],
            cwd: process.cwd(),
            env: { PIKU_ACP_SESSION_LIFECYCLE: "1" },
          },
          cwd: process.cwd(),
          clientInfo: { name: "piku-acp-test", version: "0.0.0" },
          ownDetachedProcessGroup: true,
          processGroupPlatform: "win32",
  ...
  it.live("poisons the session when hard teardown defects and blocks replacement work", () =>
    Effect.gen(function* () {
      ...
      const commandPidPath = yield* fileSystem.makeTempFileScoped({
        prefix: "piku-acp-failed-teardown-command-",
      });
      ...
      const adapter = makeAcpAdapterV2({
        ...
        flavor: {
          ...
          makeRuntime: makeMockRuntime({
            ...
            environment: {
              PIKU_ACP_EMIT_RUNNING_COMMAND_THEN_HANG: "1",
              PIKU_ACP_RESIDUAL_CALLBACK_RESPONSE_LOG_PATH: residualCallbackResponseLogPath,
              PIKU_ACP_RESIDUAL_CALLBACK_TRIGGER_PATH: residualCallbackTriggerPath,
              PIKU_ACP_RUNNING_COMMAND_PID_PATH: commandPidPath,
            },
            protocolEvents,
          }),
  ...
  it.live("quarantines old-runtime callbacks after successful hard teardown", () =>
    Effect.gen(function* () {
      ...
      const makeRuntime = makeMockRuntime({
        ...
        environment: (runtimeOrdinal) => {
          runtimeOrdinalSeen = runtimeOrdinal;
          return { PIKU_ACP_HANG_PROMPT_FOREVER: "1" };
        },
        protocolEvents,
  ...
  it.live("direct Stop skips uninterruptible ACP cancel and recovers after native teardown", () =>
    Effect.gen(function* () {
      ...
      const protocolEvents = yield* Queue.bounded<EffectAcpProtocol.AcpProtocolLogEvent>(256);
      const commandPidPath = yield* fileSystem.makeTempFileScoped({
        prefix: "piku-acp-direct-stop-command-",
      });
      yield* Effect.addFinalizer(() =>
        Effect.sync(() => cleanupPublishedDetachedFixture(commandPidPath)),
      );
          ...
          makeRuntime: makeMockRuntime({
            ...
            environment: (runtimeOrdinal) =>
              runtimeOrdinal === 1
                ? {
                    PIKU_ACP_EMIT_RUNNING_COMMAND_THEN_HANG: "1",
                    PIKU_ACP_EMIT_LATE_UPDATE_AFTER_CANCEL: "1",
                    PIKU_ACP_RUNNING_COMMAND_PID_PATH: commandPidPath,
                    PIKU_ACP_RUNNING_COMMAND_IGNORE_TERM: "1",
                    PIKU_ACP_RUNNING_COMMAND_SEPARATE_SESSION: "1",
                  }
                : {},
            protocolEvents,
  ...
  it.live("restart_active terminates native work and reloads a clean runtime", () =>
    Effect.gen(function* () {
      ...
      const protocolEvents = yield* Queue.bounded<EffectAcpProtocol.AcpProtocolLogEvent>(256);
      const commandPidPath = yield* fileSystem.makeTempFileScoped({
        prefix: "piku-acp-restart-active-command-",
      });
      yield* Effect.addFinalizer(() =>
        Effect.sync(() => cleanupPublishedDetachedFixture(commandPidPath)),
      );
