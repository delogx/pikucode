...
>()("piku/orchestration-v2/ContextHandoffService/ContextHandoffServiceV2") {}
...
function makeLegacyImportSummary(items: ReadonlyArray<OrchestrationV2TurnItem>): string {
  ...
  const header =
    "Imported conversation history from the previous Piku Code orchestrator. Use it as context; do not repeat it unless the user asks.";
