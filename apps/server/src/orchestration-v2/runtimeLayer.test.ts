...
const ServerConfigLayer = ServerConfig.layerTest(process.cwd(), {
  prefix: "piku-orchestration-v2-runtime-layer-",
});
  ...
  it.effect("applies lifecycle commands idempotently and emits archive/removal shell deltas", () =>
    Effect.gen(function* () {
      ...
      yield* orchestrator.dispatch({
        ...
        branch: "feature/v2",
        worktreePath: "/tmp/piku-v2-worktree",
      });
      ...
      assert.equal(projection.thread.worktreePath, "/tmp/piku-v2-worktree");
