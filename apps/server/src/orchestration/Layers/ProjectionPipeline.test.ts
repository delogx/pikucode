...
const BaseTestLayer = makeProjectionPipelinePrefixedTestLayer("piku-projection-pipeline-test-");
...
it.layer(Layer.fresh(makeProjectionPipelinePrefixedTestLayer("piku-base-")))(
...
it.layer(Layer.fresh(makeProjectionPipelinePrefixedTestLayer("piku-projection-attachments-safe-")))(
  "OrchestrationProjectionPipeline",
  (it) => {
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("piku-projection-attachments-overwrite-")),
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("piku-projection-attachments-rollback-")),
)("OrchestrationProjectionPipeline", (it) => {
    ...
    Effect.gen(function* () {
      ...
      yield* appendAndProject({
        ...
        payload: {
          ...
          checkpointRef: CheckpointRef.make("refs/piku/checkpoints/thread-revert-files/turn/1"),
          status: "ready",
          files: [],
      ...
      yield* appendAndProject({
        ...
        payload: {
          ...
          checkpointRef: CheckpointRef.make("refs/piku/checkpoints/thread-revert-files/turn/2"),
          status: "ready",
          files: [],
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("piku-projection-attachments-revert-")),
)("OrchestrationProjectionPipeline", (it) => {
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("piku-projection-attachments-delete-")),
)("OrchestrationProjectionPipeline", (it) => {
      ...
      Effect.gen(function* () {
        ...
        yield* appendAndProject({
          ...
          payload: {
            ...
            turnId: TurnId.make("turn-completed"),
            checkpointTurnCount: 1,
            checkpointRef: CheckpointRef.make("refs/piku/checkpoints/thread-conflict/turn/1"),
            status: "ready",
            files: [],
    ...
    Effect.gen(function* () {
      ...
      yield* appendAndProject({
        ...
        payload: {
          ...
          checkpointTurnCount: 1,
          checkpointRef: CheckpointRef.make("refs/piku/checkpoints/thread-revert/turn/1"),
          status: "ready",
          files: [],
      ...
      yield* appendAndProject({
        ...
        payload: {
          ...
          checkpointTurnCount: 2,
          checkpointRef: CheckpointRef.make("refs/piku/checkpoints/thread-revert/turn/2"),
          status: "ready",
          files: [],
...
it.layer(makeProjectionPipelinePrefixedTestLayer("piku-pending-turn-terminal-test-"))(
    ...
    Effect.provide(
      Layer.provideMerge(
        ServerConfig.layerTest(process.cwd(), {
          prefix: "piku-projection-pipeline-restart-",
        }),
        NodeServices.layer,
      ),
    ),
...
const engineLayer = it.layer(
  OrchestrationEngineLive.pipe(
    ...
    Layer.provideMerge(
      ServerConfig.layerTest(process.cwd(), {
        prefix: "piku-projection-pipeline-engine-dispatch-",
      }),
    ),
    Layer.provideMerge(NodeServices.layer),
  ),
