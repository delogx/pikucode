...
>()("piku/project/ProjectFaviconResolver") {}
...
export const make = Effect.gen(function* () {
  ...
  const projectFileLoader = yield* PikuProjectFileLoader.PikuProjectFileLoader;
  ...
  const resolvePath: ProjectFaviconResolver["Service"]["resolvePath"] = Effect.fn(
    ...
    // A piku.json iconPath takes precedence over the well-known locations.
