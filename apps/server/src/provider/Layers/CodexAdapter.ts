          ...
          ...(mcpSession
            ? {
                environment: {
                  ...
                  PIKU_MCP_BEARER_TOKEN: mcpSession.authorizationHeader.replace(/^Bearer\s+/, ""),
                },
                appServerArgs: [
                  "-c",
                  `mcp_servers.piku-code.url=${mcpSession.endpoint}`,
                  "-c",
                  'mcp_servers.piku-code.bearer_token_env_var="PIKU_MCP_BEARER_TOKEN"',
                ],
              }
            : {}),
        };
