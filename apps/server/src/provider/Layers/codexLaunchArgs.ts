import { tokenizeCliArgs } from "@piku/shared/cliArgs";

export const PIKU_CODEX_LAUNCH_ARGS_ENV = "PIKU_CODEX_LAUNCH_ARGS";

export const resolveCodexLaunchArgs = (
  launchArgs?: string,
  environment: NodeJS.ProcessEnv = process.env,
) => environment[PIKU_CODEX_LAUNCH_ARGS_ENV]?.trim() || launchArgs?.trim() || "";
