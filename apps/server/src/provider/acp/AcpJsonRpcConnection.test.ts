    ...
    return Effect.gen(function* () {
      ...
      Effect.provide(
        AcpSessionRuntime.layer({
          ...
          clientInfo: { name: "piku-test", version: "0.0.0" },
          authMethodId: "test",
          requestLogger: (event) =>
            Effect.sync(() => {
      ...
      Effect.provide(
        AcpSessionRuntime.layer({
          ...
          spawn: {
            command: mockAgentCommand,
            args: mockAgentArgs,
            env: { PIKU_ACP_AUTH_METHOD_ID: "test" },
          },
          cwd: process.cwd(),
          clientInfo: { name: "piku-test", version: "0.0.0" },
          requestLogger: (event) =>
      ...
      Effect.provide(
        AcpSessionRuntime.layer({
          ...
          spawn: {
            ...
            args: mockAgentArgs,
            env: {
              PIKU_ACP_AUTH_METHOD_ID: "test",
              PIKU_ACP_REQUIRE_AUTH: "1",
            },
          },
          cwd: process.cwd(),
          clientInfo: { name: "piku-test", version: "0.0.0" },
      ...
      Effect.provide(
        AcpSessionRuntime.layer({
          spawn: {
            ...
            args: mockAgentArgs,
            env: {
              PIKU_ACP_EMIT_FOREIGN_SESSION_UPDATES: "1",
            },
          },
          cwd: process.cwd(),
          clientInfo: { name: "piku-test", version: "0.0.0" },
      ...
      Effect.provide(
        AcpSessionRuntime.layer({
          spawn: {
            ...
            args: mockAgentArgs,
            env: {
              PIKU_ACP_HANG_FIRST_PROMPT_FOREVER: "1",
            },
          },
          cwd: process.cwd(),
          clientInfo: { name: "piku-test", version: "0.0.0" },
      ...
      Effect.provide(
        AcpSessionRuntime.layer({
          spawn: {
            ...
            args: mockAgentArgs,
            env: {
              PIKU_ACP_EMIT_INTERLEAVED_ASSISTANT_TOOL_CALLS: "1",
            },
          },
          cwd: process.cwd(),
          clientInfo: { name: "piku-test", version: "0.0.0" },
      ...
      Effect.provide(
        AcpSessionRuntime.layer({
          spawn: {
            ...
            args: mockAgentArgs,
            env: {
              PIKU_ACP_EMIT_GENERIC_TOOL_PLACEHOLDERS: "1",
            },
          },
          cwd: process.cwd(),
          clientInfo: { name: "piku-test", version: "0.0.0" },
    ...
    Effect.gen(function* () {
      ...
      const runtime = yield* AcpSessionRuntime.make({
        ...
        spawn: {
          ...
          args: mockAgentArgs,
          env: {
            PIKU_ACP_DELAY_LOAD_SESSION_AFTER_REPLAY: "1",
            PIKU_ACP_LOAD_SESSION_DELAY_MS: "250",
          },
        },
        cwd: process.cwd(),
  ...
  it.effect("completes session/load after replay becomes idle while its RPC stays pending", () =>
    Effect.gen(function* () {
      ...
      expect(started.sessionSetupResult._meta).toMatchObject({
        pikuSessionLoadReady: "replay_idle",
      });
      ...
      Effect.provide(
        AcpSessionRuntime.layer({
          ...
          spawn: {
            ...
            args: mockAgentArgs,
            env: {
              PIKU_ACP_HANG_LOAD_SESSION_AFTER_REPLAY: "1",
              PIKU_ACP_LOAD_SESSION_DELAY_MS: "10000",
            },
          },
          cwd: process.cwd(),
          resumeSessionId: "mock-session-1",
      ...
      Effect.provide(
        AcpSessionRuntime.layer({
          ...
          spawn: {
            ...
            args: mockAgentArgs,
            env: {
              PIKU_ACP_REQUEST_LOG_PATH: requestLogPath,
            },
          },
          cwd: process.cwd(),
          clientInfo: { name: "piku-test", version: "0.0.0" },
