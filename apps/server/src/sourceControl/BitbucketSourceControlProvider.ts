...
import { SourceControlProviderError, type ChangeRequest } from "@piku/contracts";
...
export const makeDiscovery = Effect.gen(function* () {
  ...
  return {
    ...
    label: "Bitbucket",
    installHint:
      "Set PIKU_BITBUCKET_EMAIL and PIKU_BITBUCKET_API_TOKEN on the server (use a Bitbucket API token with pull request and repository scopes).",
