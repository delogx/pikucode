  ...
  const checkpoints: VcsDriver.VcsCheckpointOps = {
    captureCheckpoint: Effect.fn("GitVcsDriver.checkpoints.captureCheckpoint")(function* (input) {
      ...
      const tempIndexPath = path.join(
        gitCommonDir,
        `piku-checkpoint-index-${NodeCrypto.randomUUID()}`,
      );
      const commitEnv: NodeJS.ProcessEnv = {
        ...process.env,
        GIT_INDEX_FILE: tempIndexPath,
        GIT_AUTHOR_NAME: "Piku Code",
        GIT_AUTHOR_EMAIL: "pikucode@users.noreply.github.com",
        GIT_COMMITTER_NAME: "Piku Code",
        GIT_COMMITTER_EMAIL: "pikucode@users.noreply.github.com",
      };
      ...
      yield* Effect.gen(function* () {
        ...
        const message = `piku checkpoint ref=${input.checkpointRef}`;
