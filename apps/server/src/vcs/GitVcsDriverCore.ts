...
import { dedupeRemoteBranchesWithLocalMatches, normalizeGitRemoteUrl } from "@piku/shared/git";
import { compactTraceAttributes } from "@piku/shared/observability";
...
> {
  ...
  const traceFilePath = yield* fs.makeTempFileScoped({
    prefix: `pikucode-git-trace2-${process.pid}-`,
    suffix: ".json",
  });
