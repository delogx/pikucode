...
import { RelayWebClientId } from "@piku/contracts/relay";
...
beforeEach(() => {
  vi.clearAllMocks();
  vi.stubEnv("VITE_PIKU_RELAY_URL", "https://relay.example.test");
