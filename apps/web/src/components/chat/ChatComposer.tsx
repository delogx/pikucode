...
import type { EnvironmentConnectionPresentation } from "@piku/client-runtime/connection";
import { serializeComposerFileLink } from "@piku/shared/composerTrigger";
import { createModelSelection, normalizeModelSlug } from "@piku/shared/model";
import {
  memo,
  type ReactNode,
  useCallback,
...
import type { UnifiedSettings } from "@piku/contracts/settings";
    ...
    if (composerTrigger.kind === "slash-command") {
      const builtInSlashCommandItems = [
        ...
        },
        {
          ...
          command: "goal",
          label: "/goal",
          description: "Set a tracked objective with optional token budget",
        },
    ...
    (item: ComposerCommandItem) => {
      ...
      if (item.type === "slash-command") {
        ...
        if (item.command === "goal") {
          // /goal wants an objective typed after it; leave the command in the
          // composer the way provider slash commands do.
