...
describe("resolveTimelineToolPresentation", () => {
  it("pretty prints Claude and Cursor Piku MCP tool names", () => {
    expect(resolveTimelineToolPresentation("mcp__piku-code__piku_thread_read")).toEqual({
  ...
  it("pretty prints Codex Piku MCP tool names", () => {
    expect(resolveTimelineToolPresentation("piku-code.create_threads")).toEqual({
