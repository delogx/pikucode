...
import type { ThreadRunSummary } from "@piku/client-runtime/state/shell";
import {
  resolvePikuMcpToolPresentation,
  type PikuMcpToolPresentation,
} from "@piku/shared/pikuMcpToolPresentation";
...
export type TimelineToolPresentation = PikuMcpToolPresentation;
export const resolveTimelineToolPresentation = resolvePikuMcpToolPresentation;
