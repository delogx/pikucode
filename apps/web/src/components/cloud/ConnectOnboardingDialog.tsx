...
import { AuthAdministrativeScopes, AuthRelayWriteScope } from "@piku/contracts";
...
/**
 * Post-sign-in onboarding wizard for Piku Connect. Opens on every in-session
 ...
 * account's Piku Connect environments so every device can be connected right
  ...
  return (
    ...
    >
      <DialogPopup className="max-w-xl">
        <DialogHeader>
          <DialogTitle>Set up Piku Connect</DialogTitle>
          <DialogDescription>
    ...
    <div className="space-y-3">
      <div className="rounded-lg border">
        <OnboardingToggleRow
          ...
          description="Make this environment available to your other devices through Piku Connect."
