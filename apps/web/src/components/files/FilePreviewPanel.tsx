...
import { isWorkspaceImagePreviewPath } from "@piku/shared/filePreview";
...
const FILE_EXPLORER_STORAGE_KEY = "pikucode.fileExplorerOpen";
const RENDER_MARKDOWN_STORAGE_KEY = "pikucode.renderMarkdown";
