import type { DiscoveredLocalServer, ScopedThreadRef } from "@piku/contracts";
import { mapAtomCommandResult, type AtomCommandResult } from "@piku/client-runtime/state/runtime";
