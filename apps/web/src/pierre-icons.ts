...
const PIERRE_ICON_SPRITE_ID = "pikucode-pierre-file-icon-sprite";

const PIKU_FILE_ICON_SPRITE = `
<svg xmlns="http://www.w3.org/2000/svg" width="0" height="0" aria-hidden="true">
  <symbol id="piku-file-icon-package-json" viewBox="0 0 32 32">
    <path d="M2 2H30V30H2" fill="#c12127" />
    <path d="M7.25 7.25h17.5v17.5h-3.5v-14H16v14H7.25" fill="#fff" />
  </symbol>
  <symbol id="piku-file-icon-tsconfig" viewBox="0 0 32 32">
  ...
  <symbol id="piku-file-icon-agents" viewBox="0 0 32 32">
  ...
  <symbol id="piku-file-icon-claude" viewBox="0 0 32 32">
  ...
  <symbol id="piku-file-icon-readme" viewBox="0 0 32 32">
  ...
  <symbol id="piku-file-icon-pnpm" viewBox="0 0 32 32">
...
export const PIKU_PIERRE_ICONS = {
  set: "complete",
  colored: true,
  spriteSheet: PIKU_FILE_ICON_SPRITE,
  byFileName: {
    "package.json": "piku-file-icon-package-json",
    "tsconfig.json": "piku-file-icon-tsconfig",
    "agents.md": "piku-file-icon-agents",
    "claude.md": "piku-file-icon-claude",
    "readme.md": "piku-file-icon-readme",
    "pnpm-lock.yaml": "piku-file-icon-pnpm",
    "pnpm-workspace.yaml": "piku-file-icon-pnpm",
  },
} satisfies FileTreeIcons;

const completeIconResolver = createFileTreeIconResolver(PIKU_PIERRE_ICONS);
...
export function ensurePierreIconSprite(): void {
  ...
  container.innerHTML = `${getBuiltInSpriteSheet("complete")}${PIKU_FILE_ICON_SPRITE}`;
