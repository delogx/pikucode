...
export class GhosttyTerminalSurface {
  ...
  static async create(
    ...
    canvas.className = "piku-ghostty-canvas";
    canvas.style.cssText = "display:block;width:100%;height:100%;";
    canvas.setAttribute("aria-hidden", "true");

    const input = document.createElement("textarea");
    input.className = "piku-ghostty-input";
    ...
    scrollbar.className = "piku-ghostty-scrollbar";
    ...
    scrollbarThumb.className = "piku-ghostty-scrollbar-thumb";
