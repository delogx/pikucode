...
export const PERSISTED_STATE_KEY = "pikucode:ui-state:v1";
const THREAD_CHANGED_FILES_EXPANSION_VERSION = 1;
const LEGACY_PERSISTED_STATE_KEYS = [
  "pikucode:renderer-state:v8",
  "pikucode:renderer-state:v7",
  "pikucode:renderer-state:v6",
  "pikucode:renderer-state:v5",
  "pikucode:renderer-state:v4",
  "pikucode:renderer-state:v3",
