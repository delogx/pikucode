...
const ROUTER_HOST = "app.pikucode.dev";
const HOSTED_WEB_CHANNEL_COOKIE = "pikucode_web_channel";
const LATEST_ORIGIN = "https://latest.app.pikucode.dev";
const NIGHTLY_ORIGIN = "https://nightly.app.pikucode.dev";
...
export const config: VercelConfig = {
  buildCommand:
    'vp run --filter @piku/web build && node ../../scripts/apply-web-brand-assets.ts --channel "${VITE_HOSTED_APP_CHANNEL:-latest}"',
  git: {
