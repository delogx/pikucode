...
const rule = createOxlintRuleHarness("pikucode/no-manual-effect-runtime-in-tests", {
  filename: "fixture.test.ts",
});

describe("pikucode/no-manual-effect-runtime-in-tests", () => {
  rule.valid(
...
const productionRule = createOxlintRuleHarness("pikucode/no-manual-effect-runtime-in-tests");
