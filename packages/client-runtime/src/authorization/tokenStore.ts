...
import { RelayManagedEndpoint } from "@piku/contracts/relay";
...
export class RemoteDpopAccessToken extends Schema.Class<RemoteDpopAccessToken>(
  "@piku/client-runtime/authorization/RemoteDpopAccessToken",
)({
...
>()("@piku/client-runtime/authorization/tokenStore/RemoteDpopAccessTokenStore") {}
