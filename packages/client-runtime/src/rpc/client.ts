import { ORCHESTRATION_V2_WS_METHODS, WS_METHODS } from "@piku/contracts";
...
}>("@piku/client-runtime/rpc/EnvironmentRpcRequestObserver", {
  defaultValue: () => ({
...
}>("@piku/client-runtime/rpc/EnvironmentRpcSubscriptionObserver", {
  defaultValue: () => ({
    observe: () => Effect.succeed(Effect.void),
  }),
}) {}
