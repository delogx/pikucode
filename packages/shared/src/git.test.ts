import type { VcsStatusRemoteResult, VcsStatusResult } from "@piku/contracts";
...
describe("normalizeGitRemoteUrl", () => {
  it("canonicalizes equivalent GitHub remotes across protocol variants", () => {
    expect(normalizeGitRemoteUrl("git@github.com:Piku/PikuCode.git")).toBe(
      "github.com/piku/pikucode",
    );
    expect(normalizeGitRemoteUrl("https://github.com/Piku/PikuCode.git")).toBe(
      "github.com/piku/pikucode",
    );
    expect(normalizeGitRemoteUrl("ssh://git@github.com/Piku/PikuCode")).toBe(
      "github.com/piku/pikucode",
    );
  });

  it("preserves nested group paths for providers like GitLab", () => {
    expect(normalizeGitRemoteUrl("git@gitlab.com:Piku/platform/PikuCode.git")).toBe(
      "gitlab.com/piku/platform/pikucode",
    );
    expect(normalizeGitRemoteUrl("https://gitlab.com/Piku/platform/PikuCode.git")).toBe(
      "gitlab.com/piku/platform/pikucode",
    );
  });
...
describe("parseGitHubRepositoryNameWithOwnerFromRemoteUrl", () => {
  it("extracts the owner and repository from common GitHub remote shapes", () => {
    expect(
      parseGitHubRepositoryNameWithOwnerFromRemoteUrl("git@github.com:Piku/PikuCode.git"),
    ).toBe("Piku/PikuCode");
    expect(
      parseGitHubRepositoryNameWithOwnerFromRemoteUrl("https://github.com/Piku/PikuCode.git"),
    ).toBe("Piku/PikuCode");
  });
});
