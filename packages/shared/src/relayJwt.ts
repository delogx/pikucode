...
export const RELAY_LINK_PROOF_TYP = "piku-env-link+jwt";
export const RELAY_MINT_REQUEST_TYP = "piku-cloud-mint+jwt";
export const RELAY_HEALTH_REQUEST_TYP = "piku-cloud-health+jwt";
export const RELAY_MINT_RESPONSE_TYP = "piku-env-mint+jwt";
export const RELAY_HEALTH_RESPONSE_TYP = "piku-env-health+jwt";
export const RELAY_ACTIVITY_PUBLISH_TYP = "piku-env-activity+jwt";
