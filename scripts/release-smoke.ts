...
const workspaceFiles = [
  ...
  "oxlint-plugin-pikucode/package.json",
...
files:
  - url: Piku-Code-9.9.9-smoke.0-arm64.zip
    sha512: arm64zip
    size: 125621344
  - url: Piku-Code-9.9.9-smoke.0-arm64.dmg
    sha512: arm64dmg
    size: 131754935
path: Piku-Code-9.9.9-smoke.0-arm64.zip
sha512: arm64zip
...
`,
  ...
  NodeFS.writeFileSync(
    ...
    `version: 9.9.9-smoke.0
files:
  - url: Piku-Code-9.9.9-smoke.0-x64.zip
    sha512: x64zip
    size: 132000112
  - url: Piku-Code-9.9.9-smoke.0-x64.dmg
    sha512: x64dmg
    size: 138148807
path: Piku-Code-9.9.9-smoke.0-x64.zip
sha512: x64zip
...
const tempRoot = NodeFS.mkdtempSync(NodePath.join(NodeOS.tmpdir(), "piku-release-smoke-"));
...
try {
  ...
  assertContains(
    nightlyReleaseMetadata,
    "name=Piku Code Nightly 9.9.10-nightly.20260413.321 (abcdef123456)",
  ...
  assertContains(
    mergedManifest,
    "Piku-Code-9.9.9-smoke.0-arm64.zip",
    "Merged manifest is missing the arm64 asset.",
  );
  assertContains(
    mergedManifest,
    "Piku-Code-9.9.9-smoke.0-x64.zip",
